...
import { AirlineSeatReclineExtra, CalendarToday, Event, LocationSearching, MyLocation, Person, Search } from "@mui/icons-material";
import { Box, Button, Card, CardContent, Divider, IconButton, InputAdornment, Stack, TextField, Typography, styled, useMediaQuery } from "@mui/material";
...
import { getValidLocation, isEmptyString, isFalsy, isNumeric, sleep } from "Utils";
                ...
                <Box p={2}>
                    <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
                        ...
                        <TextField
                            ...
                            fullWidth
                            helperText={seatsError}
                            error={!isEmptyString(seatsError) || !isEmptyString(seatsError)}
                            value={seats}
                            onChange={(e) => {
                                if (isEmptyString(e.target.value)) {
                                    setSeats('');
    ...
    <BoxV2>
        <PlaceAutocomplete
            ...
            onChange={(e) => {
                ...
                setFromError(""); // Clear error on change
            }}
            error={!isEmptyString(fromError)}
            helperText={fromError}
            InputProps={{
